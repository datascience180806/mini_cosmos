"""
Kịch bản chạy thử nghiệm suy luận cho Version 2 (~95M parameters).
"""
...
def run_inference_demo():
    print("=" * 70)
    print("BẮT ĐẦU THỬ NGHIỆM SUY LUẬN VERSION 2 MODEL (~95M PARAMS)")
    print("=" * 70)
    ...
    print("\n--- 1. CHẠY THỬ REASONER MODE (Version 2) ---")
    ...
    print("\n--- 2. CHẠY THỬ GENERATOR MODE (Version 2) ---")
    seq_ar = 8
    seq_dm = 4
    ...
    print("\n[SUCCESS] Chay thanh cong Version 2 Inference!")
