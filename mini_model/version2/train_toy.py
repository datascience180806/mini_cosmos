"""
Kịch bản huấn luyện thử nghiệm cho Version 2 (~95M parameters).
"""
...
from mini_model.version2.model import Cosmos3ToyModel, Cosmos3Config


def train_toy_step():
    print("=" * 70)
    print("BẮT ĐẦU KIỂM THỬ HUẤN LUYỆN COSMOS 3 VERSION 2 MODEL (~95M PARAMS)")
    print("=" * 70)
    ...
    print(f"[INFO] So luong tham so mo hinh Version 2: {total_params / 1e6:.2f}M params")
    ...
    print("\n[SUCCESS] Hoan thanh 5 steps huan luyen thử nghiem cho Version 2!")
