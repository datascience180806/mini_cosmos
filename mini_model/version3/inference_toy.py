"""
Kịch bản chạy thử nghiệm suy luận cho Version 3 (GQA + RoPE MoT Model).
"""
...
def run_inference_demo():
    print("=" * 70)
    print("BẮT ĐẦU THỬ NGHIỆM SUY LUẬN VERSION 3 MODEL (GQA + RoPE)")
    print("=" * 70)
    ...
    print("\n--- 1. CHẠY THỬ REASONER MODE (Version 3) ---")
    ...
    print("\n--- 2. CHẠY THỬ GENERATOR MODE (Version 3) ---")
    seq_ar = 8
    seq_dm = 4
    ...
    print("\n[SUCCESS] Chay thanh cong Version 3 Inference!")
