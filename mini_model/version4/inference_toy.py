"""
Kịch bản chạy thử nghiệm suy luận cho Version 4 (~380M parameters).
"""
...
def run_inference_demo():
    print("=" * 70)
    print("BẮT ĐẦU THỬ NGHIỆM SUY LUẬN VERSION 4 MODEL (~380M PARAMS)")
    print("=" * 70)
    ...
    print("\n--- 1. CHẠY THỬ REASONER MODE (Version 4) ---")
    ...
    print("\n--- 2. CHẠY THỬ GENERATOR MODE (Version 4) ---")
    seq_ar = 8
    seq_dm = 4
    ...
    print("\n[SUCCESS] Chay thanh cong Version 4 Inference!")
