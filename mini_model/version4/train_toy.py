"""
Kịch bản huấn luyện thử nghiệm cho Version 4 (~380M parameters).
"""
...
from mini_model.version4.model import Cosmos3ToyModel, Cosmos3Config


def train_toy_step():
    print("=" * 70)
    print("BẮT ĐẦU KIỂM THỬ HUẤN LUYỆN COSMOS 3 VERSION 4 MODEL (~380M PARAMS)")
    print("=" * 70)
    ...
    print(f"[INFO] So luong tham so mo hinh Version 4: {total_params / 1e6:.2f}M params")
    ...
    print("\n[SUCCESS] Hoan thanh 5 steps huan luyen thử nghiem cho Version 4!")
