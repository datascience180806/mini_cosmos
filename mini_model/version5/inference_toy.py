"""
Kịch bản chạy thử nghiệm suy luận cho Version 5 (~3.93B parameters).
"""
...
def run_inference_demo():
    print("=" * 70)
    print("BẮT ĐẦU THỬ NGHIỆM SUY LUẬN VERSION 5 MODEL (~3.93B PARAMS)")
    print("=" * 70)
    ...
    print("\n--- 1. CHẠY THỬ REASONER MODE (Version 5) ---")
    ...
    print("\n--- 2. CHẠY THỬ GENERATOR MODE (Version 5) ---")
    seq_ar = 8
    seq_dm = 4
    ...
    print("\n[SUCCESS] Chay thanh cong Version 5 Inference!")
