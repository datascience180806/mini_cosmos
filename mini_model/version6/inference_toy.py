"""
Kịch bản chạy thử nghiệm suy luận cho Version 6 (~6.98B parameters).
"""
...
def run_inference_demo():
    print("=" * 70)
    print("BẮT ĐẦU THỬ NGHIỆM SUY LUẬN VERSION 6 MODEL (~6.98B PARAMS)")
    print("=" * 70)
    ...
    print("\n--- 1. CHẠY THỬ REASONER MODE (Version 6) ---")
    ...
    print("\n--- 2. CHẠY THỬ GENERATOR MODE (Version 6) ---")
    seq_ar = 8
    seq_dm = 4
    ...
    print("\n[SUCCESS] Chay thanh cong Version 6 Inference!")
